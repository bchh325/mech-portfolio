...
export default function Information() {
    return (
        <div className={styles.information}>
            ...
            <div className={`${styles.infochild} ${styles.delayOne}`}>
                <span className={styles.default}>John <span className={styles.highlight}>Doe</span></span>
            </div>
            <div className={`${styles.infochild} ${styles.delayTwo}`}>
            ...
            <div className={`${styles.infochild} ${styles.delayThree}`}>
                <span className={styles.default}>Aerospace <span className={styles.highlight}>Engineering</span></span>
            </div>
            <div className={`${styles.infochild} ${styles.delayFour}`}>
